    ...
    <form action={formAction} className="space-y-4" noValidate>
      ...
      <div className="flex items-start gap-3">
        ...
        <label htmlFor="consent" className="text-sm text-slate-700 leading-relaxed">
          ...
          meiner Angaben zur Beantwortung meiner Anfrage einverstanden
      ...
      {state.message && (
        <div
          className={`rounded-lg px-4 py-3 text-sm ${state.ok ? 'bg-green-50 text-green-800' : 'bg-red-50 text-red-800'
            }`}
        >
          {state.message}
        </div>
